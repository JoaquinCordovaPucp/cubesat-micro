...
void loop() {
    ...
    if(ens160.checkDataStatus() && (ens160.getFlags() == 0) ){ // Segun la libreria: Gas Sensor Status Flag (0 - Standard, 1 - Warm up, 2 - Initial Start Up), por lo que si es 0 esta listo para medidas utiles.
